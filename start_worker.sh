# Remove the backup-servers flag to run without backups
...
python node.py --role worker --host localhost --port 50063 --master localhost:50051 --backup-servers localhost:50061